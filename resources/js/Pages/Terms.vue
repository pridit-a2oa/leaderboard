    ...
    <DefaultLayout>
        ...
        <div class="flex flex-col gap-6">
            ...
            <p>
                ...
                ('you'), and Leaderboard, concerning your access to and use of
            ...
            <p>
                ...
                arma@pridit.co.uk, as stated in the email message. By continuing
                to use the Services after the effective date of any changes, you
            ...
            <ul>
                <li>
                    <a class="underlined-link" href="#our-services"
                        >OUR SERVICES</a
                    >
                </li>
                <li>
                ...
                <li>
                    <a class="underlined-link" href="#social-media"
                        >SOCIAL MEDIA</a
                    >
                </li>
                <li>
                ...
                <li>
                    <a class="underlined-link" href="#corrections"
                        >CORRECTIONS</a
                    >
                </li>
                <li>
            ...
            <div id="intellectual-property-rights" class="flex flex-col gap-6">
                ...
                <p>
                    ...
                    email, via our website, or through our Services
                    (collectively, 'Submissions'), you agree that we are free to
                    use, disclose, reproduce, modify, licence, transfer, and
                    otherwise distribute, exploit or commercially benefit from,
                    your Submissions in any manner. However, we will not
                    disclose your name or otherwise publicly attribute your
                    Submissions unless: (a) you have given us your permission to
                    disclose your name or publicly attribute your Submissions;
                    (b) we first notify you that your Submissions will be
                    publicly disclosed and you do not object within a reasonable
                    time (or at all); or (c) we are required to do so by law.
                </p>
                ...
                <ul>
                    ...
                    <li>
                        ...
                        that you have the necessary rights and licences to
            ...
            <div id="prohibited-activities" class="flex flex-col gap-6">
                ...
                <ul>
                    ...
                    <li>
                        ...
                        any revenue-generating endeavour or commercial
                        enterprise.
                    </li>
            ...
            <div id="privacy-policy" class="flex flex-col gap-6">
                ...
                <p>
                    ...
                    Terms. Please be advised the Services are hosted in Germany
                    and United Kingdom. If you access the Services from any
                    other region of the world with laws or other requirements
                    governing personal data collection, use, or disclosure that
                    differ from applicable laws in Germany and United Kingdom,
                    then through your continued use of the Services, you are
                    transferring your data to Germany and United Kingdom, and
                    you expressly consent to have your data transferred to and
                    processed in Germany and United Kingdom.
                </p>
            </div>
            ...
            <div id="governing-law" class="flex flex-col gap-6">
                ...
                <p>
                    ...
                    the laws of the United Kingdom, and the use of the United
                    Nations Convention of Contracts for the International Sales
