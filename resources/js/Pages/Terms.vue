...
<template>
    ...
    <LegalLayout>
        ...
        <p>
            We are Pridit's Domination Takistan ('<strong>Company</strong>',
        ...
        <p>
            ...
            <Link class="underlined-link" :href="route('home')"
                >https://arma.pridit.co.uk</Link
            >
            (the '<strong>Site</strong>'), as well as any other related products
            and services that refer or link to these legal terms (the '<strong
                >Legal Terms</strong
        ...
        <p>
            ...
            <a class="underlined-link" href="mailto:privacy@pridit.co.uk"
        ...
        <p>
            ...
            and Pridit's Domination Takistan, concerning your access to and use
        ...
        <p>
            ...
            effective upon posting or notifying you by arma@pridit.co.uk, as
        ...
        <ul>
            <li>
                <a class="underlined-link" href="#our-services">OUR SERVICES</a>
            </li>
            <li>
                <a class="underlined-link" href="#intellectual-property-rights"
                    >INTELLECTUAL PROPERTY RIGHTS</a
                >
            </li>
            <li>
                <a class="underlined-link" href="#user-representations"
                    >USER REPRESENTATIONS</a
                >
            </li>
            <li>
                <a class="underlined-link" href="#user-registration"
                    >USER REGISTRATION</a
                >
            </li>
            <li>
                <a class="underlined-link" href="#prohibited-activities"
                    >PROHIBITED ACTIVITIES</a
                >
            </li>
            <li>
                <a class="underlined-link" href="#user-generated-contributions"
                    >USER GENERATED CONTRIBUTIONS</a
                >
            </li>
            <li>
                <a class="underlined-link" href="#contribution-licence"
                    >CONTRIBUTION LICENCE</a
                >
            </li>
            <li>
                <a class="underlined-link" href="#social-media">SOCIAL MEDIA</a>
            </li>
            <li>
                <a
            ...
            <li>
                <a class="underlined-link" href="#services-management"
                    >SERVICES MANAGEMENT</a
                >
            </li>
            <li>
                <a class="underlined-link" href="#privacy-policy"
                    >PRIVACY POLICY</a
                >
            </li>
            <li>
                <a class="underlined-link" href="#term-and-termination"
            ...
            <li>
                <a class="underlined-link" href="#governing-law"
                    >GOVERNING LAW</a
                >
            </li>
            <li>
                <a class="underlined-link" href="#dispute-resolution"
                    >DISPUTE RESOLUTION</a
                >
            </li>
            <li>
                <a class="underlined-link" href="#corrections">CORRECTIONS</a>
            </li>
            <li>
                <a class="underlined-link" href="#disclaimer">DISCLAIMER</a>
            </li>
            <li>
                <a class="underlined-link" href="#limitations-of-liability"
                    >LIMITATIONS OF LIABILITY</a
                >
            </li>
            <li>
                <a class="underlined-link" href="#indemnification"
                    >INDEMNIFICATION</a
                >
            </li>
            <li>
                <a class="underlined-link" href="#user-data">USER DATA</a>
            </li>
            <li>
                <a
                    class="underlined-link"
            ...
            <li>
                <a class="underlined-link" href="#miscellaneous"
                    >MISCELLANEOUS</a
                >
            </li>
            <li>
                <a class="underlined-link" href="#contact-us">CONTACT US</a>
            </li>
        </ul>

        <div id="our-services" class="flex flex-col gap-6">
        ...
        <div id="intellectual-property-rights" class="flex flex-col gap-6">
            ...
            <p>
                ...
                question, suggestion, idea, feedback, or other content via
                email, via our website, or through our Services (collectively,
                'Submissions'), you agree that we are free to use, disclose,
                reproduce, modify, licence, transfer, and otherwise distribute,
                exploit or commercially benefit from, your Submissions in any
                manner. However, we will not disclose your name or otherwise
                publicly attribute your Submissions unless: (a) you have given
                us your permission to disclose your name or publicly attribute
                your Submissions; (b) we first notify you that your Submissions
                will be publicly disclosed and you do not object within a
                reasonable time (or at all); or (c) we are required to do so by
                law.
            </p>

            <p>
                <strong
                    >You are responsible for what you post or upload:</strong
                >
            ...
            <ul>
                ...
                <li>
                    ...
                    you have the necessary rights and licences to submit such
        ...
        <div id="user-representations" class="flex flex-col gap-6">
        ...
        <div id="user-registration" class="flex flex-col gap-6">
        ...
        <div id="prohibited-activities" class="flex flex-col gap-6">
        ...
        <div id="user-generated-contributions" class="flex flex-col gap-6">
            <h2>6. USER GENERATED CONTRIBUTIONS</h2>

            <p>The Services does not offer users to submit or post content.</p>
        </div>

        <div id="contribution-licence" class="flex flex-col gap-6">
        ...
        <div id="social-media" class="flex flex-col gap-6">
        ...
        <div id="third-party-websites-and-content" class="flex flex-col gap-6">
        ...
        <div id="services-management" class="flex flex-col gap-6">
        ...
        <div id="privacy-policy" class="flex flex-col gap-6">
            ...
            <p>
                ...
                <Link class="underlined-link" :href="route('privacy')"
                    >https://arma.pridit.co.uk/privacy</Link
                >. By using the Services, you agree to be bound by our Privacy
                Policy, which is incorporated into these Legal Terms. Please be
                advised the Services are hosted in Germany and United Kingdom.
                ...
                in Germany and United Kingdom, then through your continued use
                of the Services, you are transferring your data to Germany and
                United Kingdom, and you expressly consent to have your data
                transferred to and processed in Germany and United Kingdom.
            </p>
        </div>

        <div id="term-and-termination" class="flex flex-col gap-6">
        ...
        <div id="modifications-and-interruptions" class="flex flex-col gap-6">
        ...
        <div id="governing-law" class="flex flex-col gap-6">
        ...
        <div id="dispute-resolution" class="flex flex-col gap-6">
            <h2>15. DISPUTE RESOLUTION</h2>

            <p>
                The European Commission provides an
                <NormalLink href="https://ec.europa.eu/consumers/odr" size="2xs"
                    >online dispute resolution platform</NormalLink
                >, which you can access. If you would like to bring this subject
                to our attention, please contact us.
            </p>
        </div>

        <div id="corrections" class="flex flex-col gap-6">
        ...
        <div id="disclaimer" class="flex flex-col gap-6">
            <h2>17. DISCLAIMER</h2>
        ...
        <div id="limitations-of-liability" class="flex flex-col gap-6">
        ...
        <div id="indemnification" class="flex flex-col gap-6">
        ...
        <div id="user-data" class="flex flex-col gap-6">
            <h2>20. USER DATA</h2>
        ...
        <div id="california-users-and-residents" class="flex flex-col gap-6">
        ...
        <div id="miscellaneous" class="flex flex-col gap-6">
        ...
        <div id="contact-us" class="flex flex-col gap-6">
            <h2>24. CONTACT US</h2>
